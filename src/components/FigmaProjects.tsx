      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-2 sm:gap-3 lg:gap-1.5 xl:gap-2 2xl:gap-4 flex-1">
        {figmaProjects.map((project) => (
          <a
            ...
            className="figma-project-card bg-gray-800 rounded-md border border-purple-500/20 p-2 sm:p-3 lg:p-1.5 xl:p-2 2xl:p-3 hover:border-purple-500/40 transition-all duration-300 cursor-pointer hover:bg-gray-750 w-full text-left group"
          >
